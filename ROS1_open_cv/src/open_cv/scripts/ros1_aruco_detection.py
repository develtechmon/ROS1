...
#calib_path=r"/Users/capt_luke/Desktop/My_Project/ROS1/ROS1_open_cv/src/open_cv/aruco/calibration_files/"
...
def image_callback(img_msg):
    ...
    bridge = CvBridge()
    message = cv_image = bridge.imgmsg_to_cv2(img_msg, desired_encoding='bgr8')
