...
pid_roll = PID(P, I, D, setpoint=0)  # Start with just proportional control
pid_pitch = PID(P, I, D, setpoint=0)
pid_throttle = PID(P, I, D, setpoint=1)  # Assuming desired altitude is 1 meter
