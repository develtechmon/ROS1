...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'harshmittal <harshmittal2210@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation_stack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jlukas/Desktop/My_Project/ROS1/SLAM_NAV/Robotics_ws/src/navigation_stack/${idir}'.  ${_report}")
    endif()
    _list_append_unique(navigation_stack_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "navigation_stack")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT navigation_stack_NUM_DUMMY_TARGETS)
      set(navigation_stack_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::navigation_stack::wrapped-linker-option${navigation_stack_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR navigation_stack_NUM_DUMMY_TARGETS "${navigation_stack_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::navigation_stack::wrapped-linker-option${navigation_stack_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND navigation_stack_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jlukas/Desktop/My_Project/ROS1/SLAM_NAV/Robotics_ws/devel/lib;/home/jlukas/Desktop/My_Project/SLAM_NAV/Robotics_ws/devel/lib;/opt/ros/melodic/lib)
...
set(navigation_stack_EXPORTED_TARGETS "")
...
set(depends "amcl;dwa_local_planner;gmapping;map_server;move_base;roscpp;rospy;sensor_msgs;tf;geometry_msgs;nav_msgs;gazebo_ros")
